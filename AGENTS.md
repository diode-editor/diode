...
- TUIDom (движок TUI) — отдельный репозиторий [github.com/tuidom/tuidom](https://github.com/tuidom/tuidom), пакет `@tuidom/all`; его доки (LAYOUT.md, STYLES.md, arch/) живут там
