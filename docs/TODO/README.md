...
- [x] [TuidomExtraction](TuidomExtraction.md) — аудит и вынос tuidom в отдельный репозиторий: **сделано (2026-08-13)** — движок живёт в [github.com/tuidom/tuidom](https://github.com/tuidom/tuidom), vexx потребляет пакет `@tuidom/all` из npm
