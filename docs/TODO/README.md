...
- [~] [SearchPerformance](SearchPerformance.md) — тормоза курсора в дереве результатов поиска: перемножение необрезанного `preview.after`, двойной сегментации лейблов, 2–3 кадров на нажатие и O(N) стилевого прохода списка; диагностика + репро-тесты/бенч готовы, фиксы — далее
