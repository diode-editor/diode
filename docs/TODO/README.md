...
- [ ] [TuidomContracts](TuidomContracts.md) — нестыковки в контрактах ядра tuidom, найденные аудитом зрелости (2026-07-27): контракт `performLayout` (Н1), клип/хит-тест (Н2), два источника цвета (Н3), смена корня (Н4) и др.; Н1/Н2/Н4/Н6 — критерий готовности к выносу
