...
мутанта, плюс `--disableBail`: потерянный прогон — это прогон следом за
оборванным по bail, поэтому перепроверка с bail сама теряет часть мутантов и
выдаёт вместо вердикта новых «выживших». На полном прогоне флаг неподъёмен, а
на единицах мутантов стоит секунды), и вердикт берётся оттуда. Перепроверенные мутанты
