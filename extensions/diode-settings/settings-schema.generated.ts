...
export const SETTINGS_SCHEMA: readonly ISettingSchemaEntry[] = [
    ...
    {"key":"editor.codeActionsOnSave","type":"object","default":{},"description":"Code action kinds to be run on save (e.g. `{\"source.fixAll\": true}`). Kinds match hierarchically: `source.fixAll` also runs `source.fixAll.ruff`."},
    ...
    {"key":"editor.emptySelectionClipboard","type":"boolean","default":true,"description":"Controls whether copying without a selection copies the current line."},
