...
/**
 * Пользовательский кэш-каталог vexx для распакованных ассетов (вшитый
 ...
 * `${XDG_CACHE_HOME:-~/.cache}/vexx`; на Windows — `%LOCALAPPDATA%/vexx/cache`.
 */
