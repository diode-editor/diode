 ...
 *--------------------------------------------------------------------------------------------*/
//@diode:vendored microsoft/vscode@1.127.0 src/vs/editor/common/diff/defaultLinesDiffComputer/computeMovedLines.ts
// НЕ ПРАВИТЬ РУКАМИ — перегенерируется scripts/import-vscode-diff.mjs (см. AGENTS.md).

import { SequenceDiff } from './algorithms/diffAlgorithm.ts';
import type { ITimeout } from './algorithms/diffAlgorithm.ts';
import { DetailedLineRangeMapping, LineRangeMapping } from '../rangeMapping.ts';
import { pushMany, compareBy, numberComparator, reverseOrder } from '../../../../base/common/arrays.ts';
import { MonotonousArray, findLastMonotonous } from '../../../../base/common/arraysFind.ts';
import { SetMap } from '../../../../base/common/map.ts';
import { LineRange, LineRangeSet } from '../../core/ranges/lineRange.ts';
import { LinesSliceCharSequence } from './linesSliceCharSequence.ts';
import { LineRangeFragment, isSpace } from './utils.ts';
