 ...
 *--------------------------------------------------------------------------------------------*/
//@diode:vendored microsoft/vscode@1.127.0 src/vs/editor/common/diff/defaultLinesDiffComputer/defaultLinesDiffComputer.ts
// НЕ ПРАВИТЬ РУКАМИ — перегенерируется scripts/import-vscode-diff.mjs (см. AGENTS.md).

import { equals } from '../../../../base/common/arrays.ts';
import { assertFn } from '../../../../base/common/assert.ts';
...
import { LinesDiff, MovedText } from '../linesDiffComputer.ts';
import type { ILinesDiffComputer, ILinesDiffComputerOptions } from '../linesDiffComputer.ts';
import { DetailedLineRangeMapping, LineRangeMapping, lineRangeMappingFromRangeMappings, RangeMapping } from '../rangeMapping.ts';
import { DateTimeout, InfiniteTimeout, SequenceDiff } from './algorithms/diffAlgorithm.ts';
import type { ITimeout } from './algorithms/diffAlgorithm.ts';
import { DynamicProgrammingDiffing } from './algorithms/dynamicProgrammingDiffing.ts';
import { MyersDiffAlgorithm } from './algorithms/myersDiffAlgorithm.ts';
import { computeMovedLines } from './computeMovedLines.ts';
import { extendDiffsToEntireWordIfAppropriate, optimizeSequenceDiffs, removeShortMatches, removeVeryShortMatchingLinesBetweenDiffs, removeVeryShortMatchingTextBetweenLongDiffs } from './heuristicSequenceOptimizations.ts';
import { LineSequence } from './lineSequence.ts';
import { LinesSliceCharSequence } from './linesSliceCharSequence.ts';
