 ...
 *--------------------------------------------------------------------------------------------*/
//@diode:vendored microsoft/vscode@1.127.0 src/vs/editor/common/diff/defaultLinesDiffComputer/algorithms/dynamicProgrammingDiffing.ts
...
import { SequenceDiff, InfiniteTimeout, DiffAlgorithmResult } from './diffAlgorithm.ts';
import type { IDiffAlgorithm, ISequence, ITimeout } from './diffAlgorithm.ts';
import { Array2D } from '../utils.ts';
