 ...
 *--------------------------------------------------------------------------------------------*/
//@diode:vendored microsoft/vscode@1.127.0 src/vs/editor/common/core/ranges/lineRange.ts
...
import { OffsetRange } from './offsetRange.ts';
import { Range } from '../range.ts';
import type { IRange } from '../range.ts';
import { findFirstIdxMonotonousOrArrLen, findLastIdxMonotonous, findLastMonotonous } from '../../../../base/common/arraysFind.ts';
import { compareBy, numberComparator } from '../../../../base/common/arrays.ts';
import type { Comparator } from '../../../../base/common/arrays.ts';
