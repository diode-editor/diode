 ...
 *--------------------------------------------------------------------------------------------*/
//@diode:vendored microsoft/vscode@1.127.0 src/vs/editor/common/core/text/abstractText.ts
...
import { LineRange } from '../ranges/lineRange.ts';
import { OffsetRange } from '../ranges/offsetRange.ts';
import { TextLength } from '../text/textLength.ts';
import { PositionOffsetTransformer } from './positionToOffsetImpl.ts';
