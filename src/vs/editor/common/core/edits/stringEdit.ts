 ...
 *--------------------------------------------------------------------------------------------*/
//@diode:vendored microsoft/vscode@1.127.0 src/vs/editor/common/core/edits/stringEdit.ts
...
import { StringText } from '../text/abstractText.ts';
import { BaseEdit, BaseReplacement } from './edit.ts';
