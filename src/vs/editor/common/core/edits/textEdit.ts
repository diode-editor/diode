 ...
 *--------------------------------------------------------------------------------------------*/
//@diode:vendored microsoft/vscode@1.127.0 src/vs/editor/common/core/edits/textEdit.ts
// НЕ ПРАВИТЬ РУКАМИ — перегенерируется scripts/import-vscode-diff.mjs (см. AGENTS.md).

import { compareBy, equals } from '../../../../base/common/arrays.ts';
import { assertFn, checkAdjacentItems } from '../../../../base/common/assert.ts';
import { BugIndicatingError } from '../../../../base/common/errors.ts';
import { commonPrefixLength, commonSuffixLength } from '../../../../base/common/strings.ts';
import type { ISingleEditOperation } from '../editOperation.ts';
import { BaseStringEdit, StringReplacement } from './stringEdit.ts';
import { Position } from '../position.ts';
import { Range } from '../range.ts';
import { TextLength } from '../text/textLength.ts';
import { AbstractText, StringText } from '../text/abstractText.ts';
import type { IEquatable } from '../../../../base/common/equals.ts';
