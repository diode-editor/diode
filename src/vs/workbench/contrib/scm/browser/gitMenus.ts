...
export const GIT_MENU_SUBMENUS: readonly ISubmenuContribution[] = [
    {
        ...
        submenu: GitCommitMenu,
        title: "Commit",
        group: "3_git_menus",
        order: 10,
        visible: inChangesMenu,
    },
    {
        menuId: MenuId.ViewTitle,
        submenu: GitChangesMenu,
        title: "Changes",
        group: "3_git_menus",
        order: 20,
        visible: inChangesMenu,
